...
describe('heat metric helpers', () => {
  ...
  it('calculates period changes and rejects missing periods', () => { expect(periodChange({hot_days_32:{'1961':2,'2006':5}},'hot_days_32')).toBe(3); expect(periodChange({hot_days_32:{'2006':5}},'hot_days_32')).toBeNull(); expect(averageForPeriod({'2006':null},2006,2025)).toBeNull(); });
